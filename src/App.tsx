...
function App() {
  ...
  <div className="flex flex-row flex-auto bg-white rounded-tl-xl border-l shadow-xl">
    ...
    <div className="w-3/5 border-l border-r border-gray-400 flex flex-col">
      ...
      <div
        className="flex-auto overflow-y-auto p-5 space-y-4 bg-[url('https://static.intercomassets.com/ember/assets/images/messenger-backgrounds/background-1-99a36524645be823aabcd0e673cb47f8.png')]"
      >
